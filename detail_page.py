...
from models import Comment, House, User, Recommend
...
def detail(hid):
    ...
    comments = Comment.query.filter_by(house_id=hid).all()

    return render_template('detail_page.html',comments=comments,
                           house=house, facilities=facilities_list,
